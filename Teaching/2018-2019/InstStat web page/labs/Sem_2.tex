...
\hypertarget{regresie-liniara-simpla}{%
\section{Regresie liniară simplă}\label{regresie-liniara-simpla}}

\hypertarget{metoada-celor-mai-mici-patrate}{%
...
\begin{center}\includegraphics[width=0.9\linewidth]{Sem_2_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\item
  ...
  Calculați coeficienții \(\hat{\beta}_0\) și \(\hat{\beta}_1\).
\item
...
\begin{center}\includegraphics[width=0.9\linewidth]{Sem_2_files/figure-latex/unnamed-chunk-14-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{Sem_2_files/figure-latex/unnamed-chunk-15-1} \end{center}

\hypertarget{modelare}{%
...
metoda celor mai mici pătrate este nedeplasat,
i.e.~\(\mathbb{E}[\hat{\boldsymbol \beta}] = \boldsymbol \beta\) iar
matricea de varianță-covarianță
\(Var\left(\hat{\boldsymbol \beta}\right)\) este
...
\begin{center}\includegraphics[width=0.7\linewidth]{images/sem2/RegMult_p2b} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{images/sem2/RegMult_p2c} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{Sem_2_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\item
  ...
  i.e.~\(\hat{\boldsymbol \beta}\sim\mathcal{N}(\boldsymbol \beta, \sigma^2(\boldsymbol X^\intercal\boldsymbol X)^{-1})\)
\item
...
\begin{center}\includegraphics[width=0.7\linewidth]{images/sem2/RegMult_p3} \end{center}
