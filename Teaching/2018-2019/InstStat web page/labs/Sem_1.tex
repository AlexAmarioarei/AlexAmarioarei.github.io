...
\hypertarget{estimare-prin-metoda-verosimilitatii-maxime}{%
\section{Estimare prin metoda verosimilității
maxime}\label{estimare-prin-metoda-verosimilitatii-maxime}}

\hypertarget{metoda-verosimilitatii-maxime-si-repartitia-geometrica}{%
...
\hypertarget{exemplu-de-evm-determinat-prin-solutii-numerice}{%
...
\hypertarget{metoda-verosimilitatii-maxime-si-procese-autoregresive-arr}{%
...
\NormalTok{  epsilon =}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n}\DecValTok{-1}\NormalTok{, }\DecValTok{0}\NormalTok{, sigma)}
  
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{2}\OperatorTok{:}\NormalTok{n)\{}
\NormalTok{    y[i] =}\StringTok{ }\NormalTok{c }\OperatorTok{+}\StringTok{ }\NormalTok{rho}\OperatorTok{*}\NormalTok{y[i}\DecValTok{-1}\NormalTok{] }\OperatorTok{+}\StringTok{ }\NormalTok{epsilon[i}\DecValTok{-1}\NormalTok{]}
\NormalTok{  \}}
...
\NormalTok{  dif =}\StringTok{ }\NormalTok{y[}\DecValTok{2}\OperatorTok{:}\NormalTok{ly] }\OperatorTok{-}\StringTok{ }\NormalTok{c }\OperatorTok{-}\StringTok{ }\NormalTok{rho}\OperatorTok{*}\NormalTok{y[}\DecValTok{1}\OperatorTok{:}\NormalTok{(ly}\DecValTok{-1}\NormalTok{)]}
...
\bottomrule
\endlastfoot
\rowcolor{gray!6}  c & 1.0 & 0.9261046\\
rho & 0.5 & 0.5211693\\
\rowcolor{gray!6}  sigma & 1.0 & 1.0104216\\*
\end{longtable}
...
avem \(f_{Y_1}(y_1;\boldsymbol{\theta}) = 1\). Scrieți logaritmul
funcției de verosimilitate condiționat a modelului \(AR(1)\) pentru
eșantionul \(y_1,y_2,\ldots,y_T\).
\end{rmdexercise}
...
\hypertarget{testarea-ipotezelor-statistice}{%
\section{Testarea ipotezelor
statistice}\label{testarea-ipotezelor-statistice}}

\hypertarget{teste-parametrice-si-lema-neyman-pearson}{%
...
\hypertarget{test-bazat-pe-raportul-de-verosimilitati}{%
...
\NormalTok{  li =}\StringTok{ }\NormalTok{betai}\OperatorTok{^}\NormalTok{rho}\OperatorTok{/}\KeywordTok{gamma}\NormalTok{(rho) }\OperatorTok{*}\StringTok{ }\NormalTok{y}\OperatorTok{^}\NormalTok{\{rho}\DecValTok{-1}\NormalTok{\}}\OperatorTok{*}\KeywordTok{exp}\NormalTok{(}\OperatorTok{-}\NormalTok{y}\OperatorTok{*}\NormalTok{betai)}
...
\CommentTok{# determinam MLE }
\NormalTok{param_H0 =}\StringTok{ }\DecValTok{-4} \CommentTok{# valori initiale}
