...
output:
  html_document:
    ...
    toc_float:
      collapsed: no
    includes:
      in_header: header/PS_header.html
...
lab7 = "[HTML](labs/Lab7.html)"
pdf_lab7= "[PDF](labs/Lab7.pdf)"
# 
...
t5data = "~~22 Ianuarie~~ 26 Ianuarie"
...
# 
# t5 = "[Tema 5](homework/Tema5.pdf)"
# t5sol = "[Solutie Tema 5](homework/Tema5_Sol.pdf)"
# t5data = "~~13 Ianuarie~~ 16 Ianuarie"

tab = data.frame(Tema = c(t1, t2, t3, t4, t5), 
                 Data = c(t1data, t2data, t3data, t4data, t5data), 
                 Solution = c(t1sol, t2sol, t3sol, t4sol, t5sol))
...
proj1 = "[Proiect HTML]() / [Proiect PDF]()"
proj1data = ""
...
## Rezultate Sesiune Septembrie 2019
***

```{r, echo = FALSE, message=FALSE, warning=FALSE}
library(readxl)
ps_tab_R2 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx")

ps_tab_R2 = ps_tab_R2[,1:10]
ps_tab_R2$Total[ps_tab_R2$Examen == 0] = "Absent"


# tema 1
ps_tab_R2_t1 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 2)

ps_tab_R2_t1[is.na(ps_tab_R2_t1)] = 0

tema1 = paste0(" Ex1 - ", ps_tab_R2_t1$Ex1, "; Ex2 - ", ps_tab_R2_t1$Ex2, 
       "; Ex3 - ", ps_tab_R2_t1$Ex3, "; Ex4 - ", ps_tab_R2_t1$Ex4,
       "; Ex5 - ", ps_tab_R2_t1$Ex5, "; Ex6 - ", ps_tab_R2_t1$Ex6,
       "; Ex7 - ", ps_tab_R2_t1$Ex7, "; Ex8 - ", ps_tab_R2_t1$Ex8)

# tema 2
ps_tab_R2_t2 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 3)

ps_tab_R2_t2[is.na(ps_tab_R2_t2)] = 0

tema2 = paste0(" Ex1 - ", ps_tab_R2_t2$Ex1, "; Ex2 - ", ps_tab_R2_t2$Ex2, 
       "; Ex3 - ", ps_tab_R2_t2$Ex3, "; Ex4 - ", ps_tab_R2_t2$Ex4,
       "; Ex5 - ", ps_tab_R2_t2$Ex5, "; Ex6 - ", ps_tab_R2_t2$Ex6,
       "; Ex7 - ", ps_tab_R2_t2$Ex7)

# tema 3
ps_tab_R2_t3 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 4)

ps_tab_R2_t3[is.na(ps_tab_R2_t3)] = 0

tema3 = paste0(" Ex1 - ", ps_tab_R2_t3$Ex1, "; Ex2 - ", ps_tab_R2_t3$Ex2, 
       "; Ex3 - ", ps_tab_R2_t3$Ex3, "; Ex4 - ", ps_tab_R2_t3$Ex4,
       "; Ex5 - ", ps_tab_R2_t3$Ex5, "; Ex6 - ", ps_tab_R2_t3$Ex6,
       "; Ex7 - ", ps_tab_R2_t3$Ex7)

# tema 4
ps_tab_R2_t4 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 5)

ps_tab_R2_t4[is.na(ps_tab_R2_t4)] = 0

tema4 = paste0(" Ex1 - ", ps_tab_R2_t4$Ex1, "; Ex2 - ", ps_tab_R2_t4$Ex2, 
       "; Ex3 - ", ps_tab_R2_t4$Ex3, "; Ex4 - ", ps_tab_R2_t4$Ex4,
       "; Ex5 - ", ps_tab_R2_t4$Ex5, "; Ex6 - ", ps_tab_R2_t4$Ex6,
       "; Ex7 - ", ps_tab_R2_t4$Ex7)

# tema 5
ps_tab_R2_t5 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 6)

ps_tab_R2_t5[is.na(ps_tab_R2_t5)] = 0

tema5 = paste0(" Ex1 - ", ps_tab_R2_t5$Ex1, "; Ex2 - ", ps_tab_R2_t5$Ex2, 
       "; Ex3 - ", ps_tab_R2_t5$Ex3, "; Ex4 - ", ps_tab_R2_t5$Ex4,
       "; Ex5 - ", ps_tab_R2_t5$Ex5, "; Ex6 - ", ps_tab_R2_t5$Ex6)

# examen
ps_tab_R2_ex = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Septembrie.xlsx", 
                                 sheet = 7)

ps_tab_R2_ex[is.na(ps_tab_R2_ex)] = 0

examen = paste0(" Ex1 - ", ps_tab_R2_ex$Ex1, "; Ex2 - ", ps_tab_R2_ex$Ex2, 
       "; Ex3 - ", ps_tab_R2_ex$Ex3, "; Ex4 - ", ps_tab_R2_ex$Ex4,
       "; Ex5 - ", ps_tab_R2_ex$Ex5, "; Ex6 - ", ps_tab_R2_ex$Ex6,
       "; Ex7 - ", ps_tab_R2_ex$Ex7)

# 
ps_tab_R2$Tema_1_label = tema1
ps_tab_R2$Tema_2_label = tema2
ps_tab_R2$Tema_3_label = tema3
ps_tab_R2$Tema_4_label = tema4
ps_tab_R2$Tema_5_label = tema5

ps_tab_R2$ex_label = examen
...
## Rezultate Sesiune Iunie 2019
***

```{r, echo = FALSE, message=FALSE, warning=FALSE}
library(readxl)
ps_tab_E1 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx")

ps_tab_E1 = ps_tab_E1[,1:10]
ps_tab_E1$Total[ps_tab_E1$Examen == 0] = "Absent"


# tema 1
ps_tab_E1_t1 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 2)

ps_tab_E1_t1[is.na(ps_tab_E1_t1)] = 0

tema1 = paste0(" Ex1 - ", ps_tab_E1_t1$Ex1, "; Ex2 - ", ps_tab_E1_t1$Ex2, 
       "; Ex3 - ", ps_tab_E1_t1$Ex3, "; Ex4 - ", ps_tab_E1_t1$Ex4,
       "; Ex5 - ", ps_tab_E1_t1$Ex5, "; Ex6 - ", ps_tab_E1_t1$Ex6,
       "; Ex7 - ", ps_tab_E1_t1$Ex7, "; Ex8 - ", ps_tab_E1_t1$Ex8)

# tema 2
ps_tab_E1_t2 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 3)

ps_tab_E1_t2[is.na(ps_tab_E1_t2)] = 0

tema2 = paste0(" Ex1 - ", ps_tab_E1_t2$Ex1, "; Ex2 - ", ps_tab_E1_t2$Ex2, 
       "; Ex3 - ", ps_tab_E1_t2$Ex3, "; Ex4 - ", ps_tab_E1_t2$Ex4,
       "; Ex5 - ", ps_tab_E1_t2$Ex5, "; Ex6 - ", ps_tab_E1_t2$Ex6,
       "; Ex7 - ", ps_tab_E1_t2$Ex7)

# tema 3
ps_tab_E1_t3 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 4)

ps_tab_E1_t3[is.na(ps_tab_E1_t3)] = 0

tema3 = paste0(" Ex1 - ", ps_tab_E1_t3$Ex1, "; Ex2 - ", ps_tab_E1_t3$Ex2, 
       "; Ex3 - ", ps_tab_E1_t3$Ex3, "; Ex4 - ", ps_tab_E1_t3$Ex4,
       "; Ex5 - ", ps_tab_E1_t3$Ex5, "; Ex6 - ", ps_tab_E1_t3$Ex6,
       "; Ex7 - ", ps_tab_E1_t3$Ex7)

# tema 4
ps_tab_E1_t4 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 5)

ps_tab_E1_t4[is.na(ps_tab_E1_t4)] = 0

tema4 = paste0(" Ex1 - ", ps_tab_E1_t4$Ex1, "; Ex2 - ", ps_tab_E1_t4$Ex2, 
       "; Ex3 - ", ps_tab_E1_t4$Ex3, "; Ex4 - ", ps_tab_E1_t4$Ex4,
       "; Ex5 - ", ps_tab_E1_t4$Ex5, "; Ex6 - ", ps_tab_E1_t4$Ex6,
       "; Ex7 - ", ps_tab_E1_t4$Ex7)

# tema 5
ps_tab_E1_t5 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 6)

ps_tab_E1_t5[is.na(ps_tab_E1_t5)] = 0

tema5 = paste0(" Ex1 - ", ps_tab_E1_t5$Ex1, "; Ex2 - ", ps_tab_E1_t5$Ex2, 
       "; Ex3 - ", ps_tab_E1_t5$Ex3, "; Ex4 - ", ps_tab_E1_t5$Ex4,
       "; Ex5 - ", ps_tab_E1_t5$Ex5, "; Ex6 - ", ps_tab_E1_t5$Ex6)

# examen
ps_tab_E1_ex = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_Restanta_Iunie.xlsx", 
                                 sheet = 7)

ps_tab_E1_ex[is.na(ps_tab_E1_ex)] = 0

examen = paste0(" Ex1 - ", ps_tab_E1_ex$Ex1, "; Ex2 - ", ps_tab_E1_ex$Ex2, 
       "; Ex3 - ", ps_tab_E1_ex$Ex3, "; Ex4 - ", ps_tab_E1_ex$Ex4,
       "; Ex5 - ", ps_tab_E1_ex$Ex5, "; Ex6 - ", ps_tab_E1_ex$Ex6,
       "; Ex7 - ", ps_tab_E1_ex$Ex7)

# 
ps_tab_E1$Tema_1_label = tema1
ps_tab_E1$Tema_2_label = tema2
ps_tab_E1$Tema_3_label = tema3
ps_tab_E1$Tema_4_label = tema4
ps_tab_E1$Tema_5_label = tema5

ps_tab_E1$ex_label = examen
...
stat_tab_R1 = read.csv("results/Tabel_Prob_Stat_2018_2019.csv", stringsAsFactors = FALSE)
...
```{r, echo = FALSE, message=FALSE, warning=FALSE}
library(readxl)
ps_tab_E1 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx")
...
# tema 1
ps_tab_E1_t1 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 2)
...
# tema 2
ps_tab_E1_t2 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 3)
...
# tema 3
ps_tab_E1_t3 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 4)
...
# tema 4
ps_tab_E1_t4 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 5)
...
# tema 5
ps_tab_E1_t5 = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 6)
...
# examen
ps_tab_E1_ex = readxl::read_xlsx("results/Tabel_Prob_Stat_2018_2019_v3.xlsx", 
                                 sheet = 7)
...
# Grupa 241
gr241 = ps_tab_E1[ps_tab_E1$Grupa == 241,]
gr241$Total[gr241$Total == "Absent"] = 0

# Grupa 242
gr242 = ps_tab_E1[ps_tab_E1$Grupa == 242,]
gr242$Total[gr242$Total == "Absent"] = 0

# Grupa 243
gr243 = ps_tab_E1[ps_tab_E1$Grupa == 243,]
gr243$Total[gr243$Total == "Absent"] = 0

# Grupa 244
gr244 = ps_tab_E1[ps_tab_E1$Grupa == 244,]
gr244$Total[gr244$Total == "Absent"] = 0

# library(plotly)

pstat_tab_p = ps_tab_E1[ps_tab_E1$Total != "Absent", ]
pstat_tab_p = pstat_tab_p %>% mutate(ID = ifelse(Total == "4", TRUE, FALSE),
                                     Grupa2 = paste0("Grupa ", Grupa))

pstat_tab_p = pstat_tab_p[which(pstat_tab_p$Grupa2 != "Grupa 343"), ]
...
***
  ...
  4. Jean Jacod, Philip Protter - *Probability Essentials*, Springer
  5. Geoffrey Grimmett, David Stirzaker - *Probability and Random Processes*
  6. John Rice - *Mathematical Statistics and Data Analysis*, Duxbury
