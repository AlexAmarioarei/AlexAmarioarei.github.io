...
\lhead{\textit{Curs}: Probabilități și Statistică (2019)\\ \textit{Instructor}: A. Am\u arioarei}
\rfoot{Pagina \thepage}
...
{\centering \includegraphics[width=0.8\linewidth]{Lab1_files/figure-latex/unnamed-chunk-29-1} 

}

\caption{Scalari, Vectori, Matrice}\label{fig:unnamed-chunk-29}
\end{figure}
