...
```{r, echo= FALSE}
stat_tab_R1 = read.csv("results/Tabel_Biostatistica_R2.csv", stringsAsFactors = FALSE)
...
### Rezultate sesiunea 29 mai - 3 iunie 2017

```{r, echo= FALSE}
stat_tab_R1 = read.csv("results/Tabel_Biostatistica_R1.csv", stringsAsFactors = FALSE)
...
### Rezultate sesiunea 14-27 mai 2017
