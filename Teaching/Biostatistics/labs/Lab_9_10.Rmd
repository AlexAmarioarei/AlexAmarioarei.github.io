...
library(ellipse)
library(plot3D)
source("functions/visualizeFitLm3D.R")
```
...
```{r, echo = FALSE, out.width = '90%', fig.align = 'center', fig.cap = 'Planul de regresie (albastru) si relatia cu regresiile liniare simple (liniile verzi). Punctele rosii reprezinta un esantion pentru $(X_1,X_2,Y)$ iar punctele negre sunt subesantioane pentru $(X_1,X_2)$ (la baza), $(X_1,Y)$ (stanga) si $(X_2,Y)$ (dreapta).', warning=FALSE}
...
```{r, echo = FALSE, out.width = '90%', fig.align = 'center', fig.cap = "Planul de regresie. Spatiul dintre cele doua plane galbene arata unde se afla 95% din observatii (dupa modelul ales)."}
#' # Generate data
X <- rnorm(100, sd = 1.5)
Y <- rnorm(100, sd = 1.5)
...
```{r, out.width = '90%', fig.align = 'center', fig.cap="Regiune de incredere pentru Area si Adjacent"}
