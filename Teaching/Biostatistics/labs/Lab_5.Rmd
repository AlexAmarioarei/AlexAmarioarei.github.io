---
title: "Curs Biostatistica 2017 - Laborator 5 & 6"
...
plot(x,df(x, df1, df2),type="l",
     main = paste("Repartitia Fisher cu df1 =", 
                  df1,"si df2 =", df2,"grade de libertate"),
...
dat1 = summarySE(Cushings, measurevar="Tetrahydrocortisone", 
                 groupvars=c("Type"))
...
dat2 = summarySE(Cushings_tr, measurevar="Tetrahydrocortisone", 
                 groupvars=c("Type"))
...
```{r, echo=FALSE, out.width = '90%', fig.align = 'center'}
dat_chol = summarySE(cholesterol, measurevar="response", 
                     groupvars=c("trt"))
...
tab_anova2$F_test = c("$\\frac{MS_A}{MS_W}$", "$\\frac{MS_B}{MS_W}$", 
                      "$\\frac{MS_{A\\times B}}{MS_W}$", "", "")
...
```{r, out.width = '90%', fig.align = 'center', echo=FALSE, warning=FALSE, message=FALSE}
library(ggplot2)
