...
tabLab = data.frame(Nr = c(1,"",2, "", 3),
                    Lab = c(lab1, labn,lab2, labn, lab3), 
                    data = c(data_lab1, data_n,data_lab2, data_n, data_lab3), 
                    readings = c(readings_lab1, readings_lab1_b,readings_lab2, readings_lab2_b, readings_lab3))
