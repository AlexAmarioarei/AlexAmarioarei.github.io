...
tabLab = data.frame(Nr = c(1,2,3,4),
                    Lab = c("Laborator 1", "Laborator 2", "Laborator 3", "Laborator 4"),
                    Htmls = c(lab1, lab2, lab3, lab4),
                    Pdfs = c(pdf_lab1, pdf_lab2, pdf_lab3, pdf_lab4))
