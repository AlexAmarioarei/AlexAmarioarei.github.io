...
proj1data = "~~2 Februarie~~ <span style = 'color: #cc0000;'>6 Februarie</span>"
...
## Rezultate sesiunea 7 - 12 septembrie 2018
***


```{r, echo = FALSE}
stat_tab_R1 = read.csv("results/Tabel_Prob_Stat_Restanta_Septembrie.csv", stringsAsFactors = FALSE)
...
```{r, echo = FALSE}
stat_tab_R1 = read.csv("results/Tabel_Prob_Stat_Restanta_Iunie.csv", stringsAsFactors = FALSE)
...
```{r, echo = FALSE}
stat_tab_R1 = read.csv("results/Tabel_Prob_Stat_5.csv", stringsAsFactors = FALSE)
...
# Grupa 241
gr241 = stat_tab_R1[stat_tab_R1$Grupa == 241,]

# Grupa 242
gr242 = stat_tab_R1[stat_tab_R1$Grupa == 242,]

# Grupa 243
gr243 = stat_tab_R1[stat_tab_R1$Grupa == 243,]

# Grupa 243
gr244 = stat_tab_R1[stat_tab_R1$Grupa == 244,]
