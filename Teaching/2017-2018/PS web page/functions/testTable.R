...
info_241 = read_excel("students/GRUPE_Informatica_an_II_2017-2018.xlsx", skip = 2, sheet = 1)
info_241_name = apply(info_241[ , 2:4] , 1 , paste , collapse = " ")
grupa_info_241 = rep(241, length(info_241_name))

info_242 = read_excel("students/GRUPE_Informatica_an_II_2017-2018.xlsx", skip = 2, sheet = 2)
info_242_name = apply(info_242[ , 2:4] , 1 , paste , collapse = " ")
grupa_info_242 = rep(242, length(info_242_name))

info_243 = read_excel("students/GRUPE_Informatica_an_II_2017-2018.xlsx", skip = 2, sheet = 3)
info_243_name = apply(info_243[ , 2:4] , 1 , paste , collapse = " ")
grupa_info_243 = rep(243, length(info_243_name))

info_244 = read_excel("students/GRUPE_Informatica_an_II_2017-2018.xlsx", skip = 2, sheet = 4)
info_244_name = apply(info_244[ , 2:4] , 1 , paste , collapse = " ")
grupa_info_244 = rep(244, length(info_244_name))

info_all_name = c(info_241_name, info_242_name, info_243_name, info_244_name)
grupa_all = c(grupa_info_241, grupa_info_242, grupa_info_243, grupa_info_244)

s = length(info_all_name)

# mate_all_name = enc2utf8(mate_all_name)

probstat = data.frame(Nume = character(s), Grupa = numeric(s), Tema_1 = numeric(s), Tema_2 = numeric(s),
                        Tema_3 = numeric(s), Tema_4 = numeric(s), Tema_5 = numeric(s), Tema_6 = numeric(s), 
                        Proiect = numeric(s), Examen = numeric(s), 
                        Total = numeric(s))

probstat$Nume = info_all_name
probstat$Grupa = grupa_all
probstat$Total = "-"

write.csv(probstat, "students/Tabel_Prob_Stat.csv", row.names = FALSE, fileEncoding = "UTF-8")
# 
# # Informatica
# #-------------
# 
