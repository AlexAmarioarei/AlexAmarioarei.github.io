...
\NormalTok{    pj =}\StringTok{ }\KeywordTok{sum}\NormalTok{(y[n[j],]}\OperatorTok{>}\NormalTok{mu}\OperatorTok{+}\NormalTok{e }\OperatorTok{|}\StringTok{ }\NormalTok{y[n[j],]}\OperatorTok{<}\NormalTok{mu}\OperatorTok{-}\NormalTok{e)}\OperatorTok{/}\NormalTok{m}
    ...
    \KeywordTok{text}\NormalTok{(n[j], b}\OperatorTok{+}\FloatTok{0.005}\NormalTok{, }\KeywordTok{round}\NormalTok{(pj, }\DataTypeTok{digits =} \DecValTok{2}\NormalTok{),}
         \DataTypeTok{cex =} \FloatTok{0.85}\NormalTok{)}
\NormalTok{  \}}
  
\NormalTok{\}}

\KeywordTok{showConvergenceProbability}\NormalTok{(}\DataTypeTok{N =} \DecValTok{5000}\NormalTok{, }\DataTypeTok{m =} \DecValTok{30}\NormalTok{, }\DataTypeTok{e =} \FloatTok{0.01}\NormalTok{, }\DataTypeTok{n =} \KeywordTok{seq}\NormalTok{(}\DecValTok{500}\NormalTok{, }\DecValTok{4500}\NormalTok{, }\DecValTok{1000}\NormalTok{), }\DataTypeTok{seed =} \DecValTok{321}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
