...
\begin{center}\includegraphics[width=0.8\linewidth]{lab_IPS_data/building} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-19-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-1} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:0f:a3:39:dd:cd 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-2} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:14:bf:b1:97:8a 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-3} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:14:bf:3b:c7:c6 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-4} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:14:bf:b1:97:90 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-5} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:14:bf:b1:97:8d 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-6} \end{center}

\begin{verbatim}
Graficul pentru adresa MAC  00:14:bf:b1:97:81 
\end{verbatim}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-37-7} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_Suplimentar_IPS_files/figure-latex/unnamed-chunk-39-1} \end{center}
...
\section{Metodă de prezicere a
locației}\label{metoda-de-prezicere-a-locatiei}
