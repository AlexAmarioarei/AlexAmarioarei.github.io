...
if (getOutputFormat() == "pdf_document"){
  knitr::include_graphics("images/sem2/reg_int_geom5.pdf")
}else{
  knitr::include_graphics("images/sem2/RegresiaLiniaraGeom5.png")
}
...
```{r, out.width = dimplot2, fig.align = 'center', echo=FALSE}
# modelul 
n = 100
x = rnorm(n)
...
data_ex = data.frame(tata = c(65, 63, 67, 64, 68, 62, 70, 66, 68, 67, 69, 71),
                     fiu = c(68, 66, 68, 65, 69, 66, 68, 65, 71, 67, 68, 70))

lm_tf = lm(tata~fiu , data = data_ex)
b0_tf = round(lm_tf$coefficients[1], 2)
b1_tf = round(lm_tf$coefficients[2], 2)

lm_ft = lm(fiu~tata, data = data_ex)
b0_ft = round(lm_ft$coefficients[1], 2)
b1_ft = round(lm_ft$coefficients[2], 2)

par(mfrow = c(1, 3))

# p1
plot(data_ex$tata, data_ex$fiu,
     pch = 16,
     col = "grey70",
     main = paste0("f = ", b0_ft, " + ", b1_ft, "t" ),
     xlab = "Greutatea tatalui",
     ylab = "Greutatea fiului",
     bty = "n",
     cex.main = 0.9)

abline(lm_ft$coefficients, col = "brown3",
       lwd = 2, lty = 2)

# p2
plot(data_ex$fiu, data_ex$tata,
     pch = 16,
     col = "grey70",
     main = paste0("t = ", b0_tf, " + ", b1_tf, "f" ),
     xlab = "Greutatea fiului",
     ylab = "Greutatea tatalui",
     bty = "n",
     cex.main = 0.9)

abline(lm_tf$coefficients, col = "royalblue",
       lwd = 2, lty = 2)
...
legend("bottomright",
       legend = c("dreapta de regresie tata ~ fiu",
                  "dreapta de regresie fiu ~ tata"),
...
# p1
curve(dt(x, df = 18), -7, 7,
      col = "royalblue", lwd = 2,
      xlab = "", ylab = TeX("$t_{18}$"),
      main = TeX("$H_0:\\,\\beta_0 = 0$ vs $H_1:\\,\\beta_0 \\neq 0$"),
      cex.axis = 0.8,
      cex.main = 0.8)

segments(qt(1-alpha/2, df = 18), 0, 
         qt(1-alpha/2, df = 18), 0.1,
         lwd = 2, lty = 2,
         col = "grey30")

text(qt(1-alpha/2, df = 18)+0.1, 0.12,
     labels = TeX("$t_{18}(1-\\alpha/2)$"),
     cex = 0.8)
...
segments(4.38, 0, 
         ...
         col = "brown3")
text(4.38+0.9, 0.065,
     labels = TeX("$\\left|\\frac{\\hat{\\beta}_0}{\\hat{\\sigma}_0}\\right|$"),
     cex = 0.8)
...
curve(dt(x, df = 18), -7, 7,
      col = "royalblue", lwd = 2,
      xlab = "", ylab = TeX("$t_{18}$"),
      main = TeX("$H_0:\\,\\beta_1 = 0$ vs $H_1:\\,\\beta_1 \\neq 0$"),
      cex.axis = 0.8,
      cex.main = 0.8)
...
segments(6.88, 0, 
         ...
         col = "brown3")
text(6.88-0.9, 0.065,
     labels = TeX("$\\left|\\frac{\\hat{\\beta}_1}{\\hat{\\sigma}_1}\\right|$"),
     cex = 0.8)
```
...
if (getOutputFormat() == "pdf_document"){
  knitr::include_graphics("images/sem2/RegMult_p1.pdf")
}else{
  knitr::include_graphics("images/sem2/RegMult_p1.png")
}
...
if (getOutputFormat() == "pdf_document"){
  knitr::include_graphics("images/sem2/RegMult_p2.pdf")
}else{
  knitr::include_graphics("images/sem2/RegMult_p2.png")
}
