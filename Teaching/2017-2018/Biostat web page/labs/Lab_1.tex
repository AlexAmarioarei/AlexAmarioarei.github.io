...
\NormalTok{x }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{9}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-85-1} \end{center}
...
{\centering \includegraphics{Lab_1_files/figure-latex/unnamed-chunk-87-1} 

}

\caption{Tipurile de simboluri asociate parametrului pch.}\label{fig:unnamed-chunk-87}
\end{figure}

Următorul exemplu ilustrează câteva tipuri de simboluri:

\begin{center}\includegraphics[width=0.8\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-88-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-93-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-102-1} \end{center}
...
O parte din cele mai cunoscute repartiții continue\footnote{Pentru mai
  multe informații, se poate consulta monografia Johnson, N., Kotz, S.
  și Balakrishnan, N. \emph{Continuous Univariate Distributions},
  (Volumul 1, Ediția a 2-a), John Wiley \& Sons, New York (1994), 756
  pp., ISBN 0-471-58495-9} sunt prezentate mai jos:
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-117-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-123-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-134-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-136-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-140-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-147-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-151-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-159-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-165-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-172-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-175-1} \end{center}
...
\begin{center}\includegraphics{Lab_1_files/figure-latex/unnamed-chunk-177-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-178-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-180-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-187-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-190-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-192-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-199-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab_1_files/figure-latex/unnamed-chunk-201-1} \end{center}
