...
$$
```{r, type = "rmdexercise", engine = engine_block}
Construiți în R o funcție care să permită calculul coeficientului de asimetrie și a coeficientului de aplatizare pentru un eșantion.  
```
...
```{r, type = "rmdexercise", engine = engine_block}
Construiți în R o funcție `JBtest()` care să implementeze testul Jarque-Bera.
```
...
JBtest = function (x){
    ...
    cat("X-squared = ", STATISTIC, ", df = ", PARAMETER, ", p-value = ", PVAL, "\n")
    
    y = list(statistic = STATISTIC, 
                parameter = PARAMETER, 
                p.value = PVAL, 
                method = METHOD)
