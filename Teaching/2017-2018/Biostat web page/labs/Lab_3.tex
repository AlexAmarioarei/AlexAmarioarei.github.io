...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\href{dataIn/normtemp.txt}{descarcă}.
\end{rmdexercise}

Acest exemplu se bazează pe articolul (Mackowiak, Wasserman, and Levine
1992), acesta reprezentând și sursa originală a datelor.
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-22-1} \end{center}

Testăm ipoteza de normalitate (folosind testul \texttt{Shapiro-Wilk}):

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# distributia pare sa fie aproape de normala si testul nu detecteaza }
\CommentTok{# o abatere semnificativa fata de normala}
\KeywordTok{shapiro.test}\NormalTok{(degreesC)}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-31-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-37-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-38-1} \end{center}
