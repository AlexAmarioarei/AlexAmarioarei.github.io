...
tabLab = data.frame(Nr = c(1, 2, 3, 4, 5, 6, 7, 8),
                    Lab = c("Laborator 1", "Laborator 2", "Laborator 3", "Laborator 4", "Laborator 5", "Laborator 6", "Laborator 7", "Laborator Suplimentar"),
                    Htmls = c(lab1, lab2, lab3, lab4, lab5, lab6, lab7, lab_sup),
                    Pdfs = c(pdf_lab1, pdf_lab2, pdf_lab3, pdf_lab4, pdf_lab5, pdf_lab6, pdf_lab7, pdf_lab_sup))
...
t4sol = "[Solutie Tema 4](homework/Tema_4_Sol.pdf)"
t4data = "~~17 Decembrie~~ 20 Decembrie"

t5 = "[Tema 5](homework/Tema_5.pdf)"
t5sol = "[Solutie Tema 5](homework/Tema_5_Sol.pdf)"
t5data = "21 Ianuarie"
...
```{r echo = FALSE}
gproj1_301 = "301"
proj1_301 = "[Proiect HTML](projects/Proiect_301.html) / [Proiect PDF](projects/Proiect_301.pdf)"
bproj1_301 = "[Barem](projects/Barem_301.pdf)"
proj1data_301 = "11 Februarie"

gproj1_311_321 = "311, 321"
proj1_311_321 = "[Proiect HTML](projects/Proiect_311_321.html) / [Proiect PDF](projects/Proiect_311_321.pdf)"
bproj1_311_321 = ""
proj1data_311_321 = "11 Februarie"
...
kable(tabProiecte, 
      col.names = c("Grupa", "Proiect Nr.", "Barem", "Data de predare"),
      align = "cccc")
```
...
Mai jos găsiți subiectele și baremul de corectare de la examenul din sesiunea 21.01.2018 - 11.02.2018:

```{r echo = FALSE}
grupe = "301, 311, 321"
exam = "[Examen](exams/Examen_301_311_2018.pdf)"
barem = "[Barem](exams/Barem_examen.pdf)"
exam_data = "11 Februarie"

tabExam = data.frame(Grupe = grupe, 
                     Exam = exam, 
                     Barem = barem,
                     Data = exam_data)

kable(tabExam, 
      col.names = c("Grupa", "Examen", "Barem", "Data"),
      align = "cccc")
```


## Rezultate sesiunea 2 - 7 iunie 2018
***

### Reexaminare

```{r, echo= FALSE}
stat_tab_R1 = read.csv("results/Tabel_Statistica_Restanta_iunie_2018.csv", stringsAsFactors = FALSE)
...
```{r, echo= FALSE}
stat_tab_R1 = read.csv("results/Tabel_Statistica_Marire_iunie_2018.csv", stringsAsFactors = FALSE)
# stat_tab_R1$Total = round(stat_tab_R1$Total, 2)
# 
# stat_tab_R1 = stat_tab_R1[,1:10]
# stat_tab_R1$Total[stat_tab_R1$Examen == 0] = "Absent"
...
## Rezultate sesiunea 7 - 12 mai 2018
***

```{r, echo= FALSE}
stat_tab_R1 = read.csv("results/Tabel_Statistica_Restanta_mai_2018.csv", stringsAsFactors = FALSE)
# stat_tab_R1$Total = round(stat_tab_R1$Total, 2)
...
stat_tab_R1 = read.csv("results/Tabel_Statistica_feb_17_2018.csv", stringsAsFactors = FALSE)
# stat_tab_R1$Total = round(stat_tab_R1$Total, 2)
...
# Grupa 301
gr301 = stat_tab_R1[stat_tab_R1$Grupa == 301,]

# Grupa 311
gr311 = stat_tab_R1[stat_tab_R1$Grupa == 311,]

# Grupa 321
gr321 = stat_tab_R1[stat_tab_R1$Grupa == 321,]

# library(plotly)

pstat_tab_p = stat_tab_R1[stat_tab_R1$Total != "Absent", ]
