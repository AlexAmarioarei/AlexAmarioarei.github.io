...
{\centering \includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-24-1} 

}

\caption{Ilustrarea legii numerelor mari: v.a. uniforme}\label{fig:unnamed-chunk-24}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-25-1} 

}

\caption{Ilustrarea legii numerelor mari: v.a. normale}\label{fig:unnamed-chunk-25}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-27-1} 

}

\caption{Convergenta metodei Monte Carlo (pentru g)}\label{fig:unnamed-chunk-27}
\end{figure}

\subsection{Ilustrarea Teoremei Limită Centrală
(I)}\label{ilustrarea-teoremei-limita-centrala-i}
...
\KeywordTok{hist}\NormalTok{(s, }\DataTypeTok{main =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Histograma raportului "}\NormalTok{,}\KeywordTok{frac}\NormalTok{(S[n]}\OperatorTok{-}\NormalTok{n}\OperatorTok{%*%}\NormalTok{mu,sigma}\OperatorTok{%*%}\KeywordTok{sqrt}\NormalTok{(n)))),}
     ...
     \DataTypeTok{border =} \StringTok{"royalblue3"}\NormalTok{,}
...
{\centering \includegraphics[width=0.8\linewidth]{Lab_3_files/figure-latex/unnamed-chunk-30-1} 

}

\caption{Ilustrarea Teoremei Limita Centrala}\label{fig:unnamed-chunk-30}
\end{figure}
