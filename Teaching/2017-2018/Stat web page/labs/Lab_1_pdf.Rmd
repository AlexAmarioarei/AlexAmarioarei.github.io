...
```{r, echo=FALSE, message=FALSE, fig.align='center', fig.cap="Numarul de pachete din R", fig.width=5}
library(ggplot2)
library(ggrepel)
...
```{r echo=FALSE, fig.align='center', fig.cap="Interfata RStudio"}
...
Table: `r "Functii folosite pentru ajutor"`
...
```{r, fig.cap = "Scalari, Vectori, Matrice", fig.align='center', echo = FALSE}
...
Table: `r "Functii care permit crearea matricelor"`
...
Table: `r "Exemple de functii necesare pentru intelegerea structurii dataframe-ului"`
...
Table: `r "Principalele argumente ale functiei subset()"`
