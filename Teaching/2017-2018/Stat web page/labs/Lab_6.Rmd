...
```{r, type = "rmdexercise", engine = engine_block}
Fie $X_1,X_2,\ldots,X_n$ un eșantion de talie $n$ dintr-o populație Laplace $L(\theta, c)$ a cărei densitate este dată de formula 
...
și aplicănd metoda lui Newton găsim estimatorul de verosimilitate maximă $\hat{\theta}_n=$ `r round(logis.newton[[1]],4)` după numai `r logis.newton[[3]]` iterații (datele au fost simulate folosin $\theta = 7.5$). 
