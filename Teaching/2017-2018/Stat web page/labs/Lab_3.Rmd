...
```{r, fig.cap="Ilustrarea legii numerelor mari: v.a. uniforme", fig.align='center', out.width="80%"}
n = 10000
...
```{r, fig.cap="Ilustrarea legii numerelor mari: v.a. normale", fig.align="center", out.width="80%"}
...
```{r, fig.cap = "Convergenta metodei Monte Carlo (pentru g)", fig.align="center", out.width="80%"}
# graficul
gn = myfun(runif(n)) 
...
```{r, fig.cap="Ilustrarea Teoremei Limita Centrala", fig.align='center', out.width="80%"}
# trasam histograma
