...
încredere și de a face câteva exemple.
...
normală de medie \(\mu\) și dispersie \(\sigma^2\). Ilustrați grafic
\(100\) de intervale de încredere pentru medie atunci când dispersia
populației este cunoscută și respectiv necunoscută folosind ca talie a
eșantionului \(n = 50\). Pentru cazul în care dispersia populației este
necunoscută, ilustrați și intervalele de încredere pentru medie
(incorecte) în care înlocuiți cuantilele repartiției Student cu cele
pentru normală.
\end{rmdexercise}
...
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{p) \{}
  \KeywordTok{set.seed}\NormalTok{(}\DecValTok{11}\OperatorTok{*}\NormalTok{i)}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_7_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_7_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_7_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
\KeywordTok{plot}\NormalTok{(n, }\KeywordTok{expo.wald.cvg}\NormalTok{(n, }\DecValTok{1}\NormalTok{, alpha), }
     ...
     \DataTypeTok{bty =} \StringTok{"n"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"royalblue"}\NormalTok{,}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_7_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab_7_files/figure-latex/unnamed-chunk-16-1} \end{center}
