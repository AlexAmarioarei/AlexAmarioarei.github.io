...
Funcția de repartiție a repartiției uniforme
\(\mathcal{U}(\{a, a+1, \ldots, b\})\) este dată de
...
\hypertarget{repartiux21bia-binomialux103-mathcalbn-p}{%
\subsection{\texorpdfstring{Repartiția binomială
\(\mathcal{B}(n, p)\)}{Repartiția binomială \textbackslash mathcal\{B\}(n, p)}}\label{repartiux21bia-binomialux103-mathcalbn-p}}

Spunem că variabila aleatoare \(X\) este repartizată binomial de
parametrii \(n\geq 1\) și \(p\in[0,1]\), și se notează cu
\(X\sim\mathcal{B}(n,p)\), dacă funcția de masă este

\[
  \mathbb{P}(X = k) = \binom{n}{k}p^k (1-p)^{n-k}, \quad k\in\{0,1,\ldots,n\}
\]

Pentru a ilustra funcția de masă vom considera repartițiile
\(\mathcal{B}(20, 0.5)\) și \(\mathcal{B}(40, 0.3)\):

\begin{center}\includegraphics[width=0.8\linewidth]{Lab4_files/figure-latex/unnamed-chunk-6-1} \end{center}

Funcția de repartiție a repartiției binomiale \(\mathcal{B}(n,p)\) este
dată de
...
\hypertarget{repartiux21bia-geometricux103-geomp}{%
\subsection{\texorpdfstring{Repartiția geometrică
\(Geom(p)\)}{Repartiția geometrică Geom(p)}}\label{repartiux21bia-geometricux103-geomp}}

Variabila aleatoare \(X\) repartizată geometric de parametru
\(p\in(0,1)\), \(X\sim Geom(p)\), are funcția de masă
...
\hypertarget{repartiux21bia-poisson-poisp}{%
\subsection{\texorpdfstring{Repartiția Poisson
\(Pois(p)\)}{Repartiția Poisson Pois(p)}}\label{repartiux21bia-poisson-poisp}}

O variabilă aleatoare \(X\) repartizată Poisson de parametru
\(\lambda>0\), \(X\sim Pois(\lambda)\), are funcția de masă dată de
...
\hypertarget{funcux21bia-de-repartiux21bie-pentru-variabile-aleatoare}{%
\section{Funcția de repartiție pentru variabile
aleatoare}\label{funcux21bia-de-repartiux21bie-pentru-variabile-aleatoare}}
...
\hypertarget{aproximarea-poisson-ux219i-normalux103-a-binomialei}{%
\section{Aproximarea Poisson și Normală a
Binomialei}\label{aproximarea-poisson-ux219i-normalux103-a-binomialei}}
...
\bottomrule
\endlastfoot
\rowcolor{gray!6}  1 & 0.3874205 & 0.3678794 & 0.0195410\\
2 & 0.1937102 & 0.1839397 & 0.0097705\\
\rowcolor{gray!6}  3 & 0.0573956 & 0.0613132 & 0.0039176\\
4 & 0.0111603 & 0.0153283 & 0.0041680\\
\rowcolor{gray!6}  5 & 0.0014880 & 0.0030657 & 0.0015776\\
\addlinespace
6 & 0.0001378 & 0.0005109 & 0.0003732\\
\rowcolor{gray!6}  7 & 0.0000087 & 0.0000730 & 0.0000642\\
8 & 0.0000004 & 0.0000091 & 0.0000088\\
\rowcolor{gray!6}  9 & 0.0000000 & 0.0000010 & 0.0000010\\
...
\bottomrule
\endlastfoot
\rowcolor{gray!6}  1 & 0.3697296 & 0.3678794 & 0.0018502\\
2 & 0.1848648 & 0.1839397 & 0.0009251\\
\rowcolor{gray!6}  3 & 0.0609992 & 0.0613132 & 0.0003141\\
4 & 0.0149417 & 0.0153283 & 0.0003866\\
\rowcolor{gray!6}  5 & 0.0028978 & 0.0030657 & 0.0001679\\
\addlinespace
6 & 0.0004635 & 0.0005109 & 0.0000475\\
\rowcolor{gray!6}  7 & 0.0000629 & 0.0000730 & 0.0000101\\
8 & 0.0000074 & 0.0000091 & 0.0000017\\
\rowcolor{gray!6}  9 & 0.0000008 & 0.0000010 & 0.0000003\\
...
\hypertarget{aproximarea-normalux103}{%
\subsection{Aproximarea Normală}\label{aproximarea-normalux103}}
...
\NormalTok{out =}\StringTok{ }\KeywordTok{appBNP}\NormalTok{(}\DataTypeTok{n =} \DecValTok{100}\NormalTok{, }\DataTypeTok{p =} \FloatTok{.01}\NormalTok{, }\DataTypeTok{k =} \DecValTok{2}\NormalTok{, }\DataTypeTok{R =} \DecValTok{1000}\NormalTok{)}
...
\NormalTok{                             n}\OperatorTok{==}\DecValTok{100}\NormalTok{, }\StringTok{", "}\NormalTok{, p}\OperatorTok{==}\FloatTok{0.01}\NormalTok{, }\DataTypeTok{sep=}\StringTok{""}\NormalTok{)),}
     \DataTypeTok{ylab =} \StringTok{"Probabilitatea"}\NormalTok{, }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(.}\DecValTok{7}\NormalTok{, }\FloatTok{.97}\NormalTok{),}
     \DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
