...
\lhead{\textit{Curs}: Probabilități și Statistică (2019-2020)\\ \textit{Instructor}: A. Am\u arioarei}
\rfoot{Pagina \thepage}
...
\item
  \texttt{pnume}: calculează funcția de repartiție,
...
\hypertarget{repartiux21bia-uniformux103}{%
\section{Repartiția Uniformă}\label{repartiux21bia-uniformux103}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{3.845944} \FloatTok{3.629965} \FloatTok{3.873795} \FloatTok{3.479156} \FloatTok{4.987640} \FloatTok{4.644032} \FloatTok{4.963637} \FloatTok{3.835652}
\NormalTok{ [}\DecValTok{9}\NormalTok{] }\FloatTok{3.983147} \FloatTok{3.495326}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{repartiux21bia-normalux103}{%
\section{Repartiția Normală}\label{repartiux21bia-normalux103}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{]  }\FloatTok{0.4721216}  \FloatTok{1.2037687} \FloatTok{-0.8957214}  \FloatTok{0.8105269}  \FloatTok{3.6389844}  \FloatTok{0.6428109}
\NormalTok{ [}\DecValTok{7}\NormalTok{]  }\FloatTok{1.7282288}  \FloatTok{0.7885207}  \FloatTok{0.3704415}  \FloatTok{1.2550551}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{-2.3263479} \FloatTok{-1.9599640} \FloatTok{-1.6448536} \FloatTok{-0.6744898}  \FloatTok{0.0000000}  \FloatTok{0.6744898}  \FloatTok{1.6448536}
\NormalTok{[}\DecValTok{8}\NormalTok{]  }\FloatTok{1.9599640}  \FloatTok{2.3263479}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{repartiux21bia-log-normalux103}{%
\section{Repartiția Log-Normală}\label{repartiux21bia-log-normalux103}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{]  }\FloatTok{2.13141475}  \FloatTok{6.27258447}  \FloatTok{2.18850080}  \FloatTok{3.15407005}  \FloatTok{0.13970018}  \FloatTok{0.52638598}
\NormalTok{ [}\DecValTok{7}\NormalTok{] }\FloatTok{12.91237780}  \FloatTok{0.12004802}  \FloatTok{1.56359485}  \FloatTok{2.01674623}  \FloatTok{5.42024453}  \FloatTok{0.54647199}
\NormalTok{[}\DecValTok{13}\NormalTok{]  }\FloatTok{1.31619806}  \FloatTok{0.04716763}  \FloatTok{1.79762358}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{repartiux21bia-exponenux21bialux103}{%
\section{Repartiția
Exponențială}\label{repartiux21bia-exponenux21bialux103}}
...
\hypertarget{repartiux21bia-cauchy}{%
\section{Repartiția Cauchy}\label{repartiux21bia-cauchy}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{-0.5966228}  \FloatTok{3.7627987}  \FloatTok{0.6864597} \FloatTok{-0.4316018}  \FloatTok{1.4524446}  \FloatTok{0.3427032}
\NormalTok{ [}\DecValTok{7}\NormalTok{]  }\FloatTok{8.4285326}  \FloatTok{3.6056089}  \FloatTok{2.3506764} \FloatTok{-3.5453329} \FloatTok{-1.6137218} \FloatTok{10.4304800}
\NormalTok{[}\DecValTok{13}\NormalTok{] }\FloatTok{-0.4449169}  \FloatTok{2.3005176} \FloatTok{-3.6644199}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{-94.46155} \FloatTok{-37.11861} \FloatTok{-17.94125}  \FloatTok{-2.00000}   \FloatTok{1.00000}   \FloatTok{4.00000}  \FloatTok{19.94125}
...
\hypertarget{repartiux21bia-gama}{%
\section{Repartiția Gama}\label{repartiux21bia-gama}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{0.6207897} \FloatTok{1.6546379} \FloatTok{0.4210210} \FloatTok{0.8476985} \FloatTok{0.2928765} \FloatTok{0.6798413} \FloatTok{1.1393160}
\NormalTok{ [}\DecValTok{8}\NormalTok{] }\FloatTok{1.0763898} \FloatTok{1.4411221} \FloatTok{0.9500644} \FloatTok{0.7387296} \FloatTok{0.4159926} \FloatTok{0.8942659} \FloatTok{0.8366199}
\NormalTok{[}\DecValTok{15}\NormalTok{] }\FloatTok{0.9733579}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{repartiux21bia-beta}{%
\section{Repartiția Beta}\label{repartiux21bia-beta}}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{3.000000000} \FloatTok{2.692520776} \FloatTok{2.401662050} \FloatTok{2.127423823} \FloatTok{1.869806094} \FloatTok{1.628808864}
\NormalTok{ [}\DecValTok{7}\NormalTok{] }\FloatTok{1.404432133} \FloatTok{1.196675900} \FloatTok{1.005540166} \FloatTok{0.831024931} \FloatTok{0.673130194} \FloatTok{0.531855956}
\NormalTok{[}\DecValTok{13}\NormalTok{] }\FloatTok{0.407202216} \FloatTok{0.299168975} \FloatTok{0.207756233} \FloatTok{0.132963989} \FloatTok{0.074792244} \FloatTok{0.033240997}
\NormalTok{[}\DecValTok{19}\NormalTok{] }\FloatTok{0.008310249} \FloatTok{0.000000000}
\end{Highlighting}
\end{Shaded}
