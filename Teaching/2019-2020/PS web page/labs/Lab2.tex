...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-32-1} \end{center}
...
{\centering \includegraphics{Lab2_files/figure-latex/unnamed-chunk-34-1} 

}

\caption{Tipurile de simboluri asociate parametrului pch.}\label{fig:unnamed-chunk-34}
\end{figure}

Următorul exemplu ilustrează câteva tipuri de simboluri:

\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
{\centering \includegraphics{Lab2_files/figure-latex/randomcolors-1} 
...
\hypertarget{funcux21bia-hist}{%
\subsection{\texorpdfstring{Funcția
\texttt{hist}}{Funcția hist}}\label{funcux21bia-hist}}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-38-1} \end{center}
...
\KeywordTok{hist}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ ChickWeight}\OperatorTok{$}\NormalTok{weight,}
     ...
     \DataTypeTok{border =} \StringTok{"white"}\NormalTok{) }\CommentTok{# Culoarea conturului}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-39-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-40-1} \end{center}

\hypertarget{funcux21bia-barplot}{%
\subsection{\texorpdfstring{Funcția
\texttt{barplot}}{Funcția barplot}}\label{funcux21bia-barplot}}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-41-1} \end{center}
...
\NormalTok{     Group}\FloatTok{.1}\NormalTok{ Group}\FloatTok{.2}\NormalTok{        x}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-43-1} \end{center}

\hypertarget{funcux21bia-boxplot}{%
\subsection{\texorpdfstring{Funcția
\texttt{boxplot}}{Funcția boxplot}}\label{funcux21bia-boxplot}}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-44-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-45-1} \end{center}

\hypertarget{funcux21bii-pentru-adux103ugarea-unor-elemente-la-un-grafic}{%
\subsection{Funcții pentru adăugarea unor elemente la un
grafic}\label{funcux21bii-pentru-adux103ugarea-unor-elemente-la-un-grafic}}
...
\KeywordTok{plot}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ mtcars}\OperatorTok{$}\NormalTok{mpg[mtcars}\OperatorTok{$}\NormalTok{am }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{], }
     ...
     \DataTypeTok{col =} \StringTok{"darkgrey"}\NormalTok{, }\DataTypeTok{bty =} \StringTok{"n"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-46-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-47-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-48-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-49-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Lab2_files/figure-latex/unnamed-chunk-50-1} \end{center}
