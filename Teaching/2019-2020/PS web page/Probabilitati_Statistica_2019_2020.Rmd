 ...
 *  _Orar_ : Miercuri 10:00 - 12:00

 *  _Sala_ : Amfiteatrul Titeica (Etaj 3) - Seria 24
 ...
 *  _Sala_ : L 204 - Grupele 241 și 242


## <span style="color: red; font-weight: bold;">IMPORTANT: INFORMAȚIE RESTANȚE</span> 
***

Din cauza situației speciale existente **examenele de restanță** se vor desfășura online. Modalitatea de examinare se va desfășura după cum urmează:

 - pentru fiecare student restanțier se va crea un folder pe Dropbox cu numele studentului la care acesta (și numai acesta) va avea acces; 
 - în ziua/ora examenului programat  fiecare student va primi simultan, în folder-ul specificat, subiectul propus spre rezolvare și cu timpul alocat; 
 - rezolvările vor fi depuse în format pdf în același folder în timpul specificat
 - orice problemă tehnică care poate să apară va fi menționată prin email (alexandru[dot]amariarei[at]fmi[dot]unibuc[dot]ro)


## Note de laborator 
***

Mai jos găsiți o parte din notele de laboratoar corespunzătoare cursului. 
...
t4sol = ""
t4data = "~~22 Decembrie~~ 29 Decembrie"
...
tab = data.frame(Tema = c(t1, t2, t3, t4), 
                 Data = c(t1data, t2data, t3data, t4data), 
                 Solution = c(t1sol, t2sol, t3sol, t4sol))
...
```{r echo = FALSE}
gproj1 = "241, 242"
proj1 = "[Proiect HTML](projects/Proiect_241_242.html) / [Proiect PDF](projects/Proiect_241_242.pdf)"
proj1data = "4 Februarie"

gproj2 = "243, 244"
proj2 = "[Proiect HTML](projects/Proiect_243_244.html) / [Proiect PDF](projects/Proiect_243_244.pdf)"
proj2data = "4 Februarie"


tabProiecte = data.frame(Tema = c(gproj1, gproj2), 
                         Data = c(proj1, proj2), 
                         Solution = c(proj1data, proj1data))
...
stat_tab_R1 = read.csv("results/Tabel_Prob_Stat_2019_2020.csv", stringsAsFactors = FALSE)
