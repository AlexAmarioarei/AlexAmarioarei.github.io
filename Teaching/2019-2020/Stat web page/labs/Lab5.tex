...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-4-1} \end{center}

și proprietatea de normalitate (TLC)

\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-5-1} \end{center}

Pentru repartiția \(\mathcal{E}(3)\) avem

\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-6-1} \end{center}

și rezultatul de normalitate asimptotică

\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-7-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-13-1} \end{center}

și proprietatea de normalitate asimptotică

\begin{center}\includegraphics[width=0.8\linewidth]{Lab5_files/figure-latex/unnamed-chunk-14-1} \end{center}

În cazul \(\mathcal{E}(3)\) avem proprietatea de convergență a
cuantilelor

\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-15-1} \end{center}

și proprietatea de normalitate asimptotică

\begin{center}\includegraphics[width=0.8\linewidth]{Lab5_files/figure-latex/unnamed-chunk-16-1} \end{center}

\hypertarget{metoda-graficux103-boxplot}{%
\section{Metoda grafică: Boxplot}\label{metoda-graficux103-boxplot}}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Lab5_files/figure-latex/unnamed-chunk-19-1} \end{center}
