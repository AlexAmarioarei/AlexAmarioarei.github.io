...
author: Researcher, Alexandru Amarioarei (alexandru.amarioarei@incdsb.ro), Senior
  Researcher, Mihaela Paun^[Corresponding Author - to whom all correspondence should
  be directed] (mihaela.paun@incdsb.ro)
...
# 
# packageurlG <- "https://cran.r-project.org/src/contrib/Archive/GGally/GGally_1.2.0.tar.gz"
# install.packages(packageurlG, repos=NULL, type="source")

# packageurlR <- "https://cran.r-project.org/src/contrib/Archive/ggrepel/ggrepel_0.5.tar.gz"
# install.packages(packageurlR, repos=NULL, type="source")
...
```{r, echo=FALSE, fig.show='hold', fig.width=6, fig.cap=fn("Romanian counties collaboration map"), eval=TRUE}
# From here nothing is included in the paper !!!!!!!!!!!
NetCountyRom
```
